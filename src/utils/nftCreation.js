...
extendBorsh();
  ...
  export const mintNFT = async function(
    ...
    console.log("Meta data inst created")
    const realFiles = [
      ...files,
      new File([JSON.stringify(metadataContent)], 'metadata.json'),
    ];

    console.log("Real fiel metat data json ", realFiles[1])
    const { instructions: pushInstructions, signers: pushSigners } = await prepPayForFilesTxn(wallet, realFiles, metadata);
    console.log("Got instr fro file upload")
    ...
    console.log("genrateted temp mint wallet")
    ...
    console.log("Receipent Key fro programAdress", recipientKey.toString())
    ...
    console.log("Meta data without URI")
    ...
    try {
      // return
      console.log("confirming txn ", txid)
     await connection.confirmTransaction(txid, 'max');
    } catch {
      // ignore
      console.log('error cofiring txn')
    }
    ...
    console.log("trying upload file to arweave")
    data.append('tags', JSON.stringify(tags));
    data.append('transaction', txid);

    realFiles.map(f => data.append('file[]', f));
    console.log("Data to arweave ", data.values())
    ...
    console.log("result from cloudfn ", result)
    ...
    console.log("Before instruc lent", updateInstructions.length)
    ...
    console.log("Current instruc lent", updateInstructions.length)
    ...
    console.log("trying to creaet Master Edition")
    ...
    console.log("Total Number of instructions ", updateInstructions.length)
  ...
  async function createMasterEdition(
    ...
    console.log("Instruction added for master edition")
  ...
  const prepPayForFilesTxn = async (
    ...
    console.log("prepaying for arweave upload")
    if (wallet.publicKey)
      instructions.push(
    ...
    console.log("creating has for ", i)
  ...
  const sendTransactionWithRetry = async (
    ...
    console.log("Sending all inst to transaction len ", instructions.length)
    instructions.forEach(instruction => transaction.add(instruction));
    transaction.recentBlockhash = (
      block || (await connection.getRecentBlockhash(commitment))
    ).blockhash;
    console.log("Recent block Hash ", transaction.recentBlockhash)
    if (includesFeePayer) {
    ...
    console.log(" Transaction sent ", txid, slot)
    return { txid, slot };
  };
  const getUnixTs = () => {
  ...
  async function updateMetadata(
    ...
    const metadataProgramId = programIds.metadata;
    console.log("updated metadata with arweave link ")
    console.log("metadataProgramId ", metadataProgramId)
    ...
    console.log("updated metadata inst created")
